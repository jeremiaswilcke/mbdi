        ...
        <main className="min-h-screen pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
            ...
            <div className="mb-16 md:flex md:items-center md:gap-12">
                <div className="md:w-1/2 mb-8 md:mb-0">
                    <div className="inline-block bg-[#69AFD2]/10 text-[#145073] font-bold px-4 py-1 rounded-full mb-4 text-sm">
                        Täglich neu
                    </div>
                    <h1 className="text-4xl md:text-6xl font-heading text-[#145073] mb-6">
                        Auf den Punkt.
                    </h1>
                    <p className="text-xl text-[#0B2E42]/80 leading-relaxed mb-4">
                        Tägliche Predigten zum <strong>Tagesevangelium</strong> und zur <strong>Tageslesung</strong> – kurz, prägnant und auf den Punkt.
                    </p>
                    <p className="text-lg text-[#0B2E42]/60 leading-relaxed mb-8">
                        ...
                        <a
                            ...
                            className="text-[#145073] font-bold hover:text-[#69AFD2] underline underline-offset-2 transition-colors"
                        >
                            „DAS LICHT 2026"
                        </a>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block bg-[#145073] hover:bg-[#69AFD2] text-white font-bold px-8 py-3 rounded-full transition-colors shadow-lg shadow-[#145073]/20"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100">
                    <div className="w-12 h-12 bg-[#69AFD2]/10 rounded-2xl flex items-center justify-center mb-6">
                        <Clock size={24} className="text-[#69AFD2]" />
                    </div>
                    <h3 className="text-xl font-heading text-[#145073] mb-3">2-3 Minuten täglich</h3>
                    <p className="text-[#0B2E42]/70">Kurze Auslegung – ideal für den Morgen, die Mittagspause oder den Abend.</p>
                </div>
                <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100">
                    ...
                    <h3 className="text-xl font-heading text-[#145073] mb-3">Tageslesung &amp; Tagesevangelium</h3>
                    <p className="text-[#0B2E42]/70">Jeden Tag passend zur liturgischen Leseordnung – Tageslesung und Tagesevangelium.</p>
                </div>
                <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100">
                    <div className="w-12 h-12 bg-[#BC8080]/10 rounded-2xl flex items-center justify-center mb-6">
                        <Mic size={24} className="text-[#BC8080]" />
                    </div>
                    <h3 className="text-xl font-heading text-[#145073] mb-3">Aus dem Studio</h3>
                    <p className="text-[#0B2E42]/70">Diakon Peter Scheuchel liest seine Predigten professionell in unserem Studio ein.</p>
                </div>
            </div>

            {/* Playlist Embed */}
            <div className="mt-24">
                <h2 className="text-3xl font-heading text-[#145073] mb-8 text-center">Aktuelle Episoden</h2>
