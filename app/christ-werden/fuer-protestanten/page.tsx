...
const fallback = {
  hero: {
    ...
    hero_description:
      "Sie sind evangelisch und fühlen sich zur katholischen Kirche hingezogen? Entdecken Sie, was die katholische Tradition zu bieten hat.",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Unfehlbarkeit bedeutet nicht, dass der Papst in allem recht hat oder nicht sündigen kann. Es bedeutet ausschließlich: Wenn der Papst in seiner höchsten Lehrautorität (ex cathedra) eine Glaubens- oder Sittenlehre als für die ganze Kirche verbindlich erklärt, bewahrt ihn der Heilige Geist vor Irrtum. Das ist in der gesamten Kirchengeschichte nur sehr selten geschehen.",
    },
    {
      question: "Ist das Fegefeuer unbiblisch?",
      answer:
        "Paulus schreibt: \"Wird aber jemandes Werk verbrennen, so wird er Schaden leiden, er selbst aber wird gerettet werden, doch so wie durch Feuer hindurch\" (1 Kor 3,15). Und in 2 Makkabäer 12,46 beten die Juden für die Verstorbenen, \"damit sie von der Sünde befreit werden.\" Das Fegefeuer ist die Reinigung derer, die in der Gnade Gottes sterben, aber noch der Läuterung bedürfen, um in die volle Gemeinschaft mit Gott einzutreten.",
    },
  ],
  contact: {
...
export default async function FuerProtestantenPage() {
  const wp = await wwdClient.getPage<WWDPageGeneric>("cw-protestanten");
  const s = wp?.sections || {};
