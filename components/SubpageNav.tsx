...
const subpages = [
  { name: "Für Suchende", href: "/christ-werden/fuer-suchende" },
  { name: "Für Muslime", href: "/christ-werden/fuer-muslime" },
  { name: "Für Protestanten", href: "/christ-werden/fuer-protestanten" },
];
